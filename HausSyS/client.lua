...
addEventHandler("onClientHouseSystemMenueUpdate", getRootElement(), function(string, value, int)
	...
	if(string == "LOCKED") then
		if(value == 0) then
			guiSetText(Knopf2[6], "Verschließen")
		else
			guiSetText(Knopf2[6], "Öffnen")
		end
	...
	elseif(string == "RENTABLE") then
		if(value == true) then
			guiSetText(Knopf2[9], "Nicht Vermietbar ")
		else
			guiSetText(Knopf2[9], " Vermietbar")
		end
...
addEventHandler("onClientHouseSystemInfoMenueOpen", gMe, function(owner, x, y, z, price, locked, rentable, rentalprice, id, doingrent, isrentedin, canadd)
	...
	Label3[1] = guiCreateLabel(12,43,253,15,"Haus ID: "..id,false,Fenster3[1])
	guiLabelSetHorizontalAlign(Label3[1],"center",false)
	guiSetFont(Label3[1],"default-bold-small")
	Label3[2] = guiCreateLabel(10,22,257,15,"Haus Information:",false,Fenster3[1])
	...
	Label3[4] = guiCreateLabel(12,61,251,18,"Ort: "..getZoneName(x, y, z, false),false,Fenster3[1])
	guiLabelSetHorizontalAlign(Label3[4],"center",false)
	guiSetFont(Label3[4],"default-bold-small")
	Label3[5] = guiCreateLabel(12,81,250,14,"Besitzer: "..owner,false,Fenster3[1])
	guiLabelSetHorizontalAlign(Label3[5],"center",false)
	guiSetFont(Label3[5],"default-bold-small")
	Label3[6] = guiCreateLabel(12,100,252,15,"Preis: $"..price,false,Fenster3[1])
	guiLabelSetHorizontalAlign(Label3[6],"center",false)
	guiSetFont(Label3[6],"default-bold-small")
	Label3[7] = guiCreateLabel(12,118,250,14,"Vermietbar?: "..rentstate,false,Fenster3[1])
	guiLabelSetHorizontalAlign(Label3[7],"center",false)
	guiSetFont(Label3[7],"default-bold-small")
	Label3[8] = guiCreateLabel(12,137,247,14,"Mietpreis: $"..rentalprice,false,Fenster3[1])
	guiLabelSetHorizontalAlign(Label3[8],"center",false)
	guiSetFont(Label3[8],"default-bold-small")
	Label3[9] = guiCreateLabel(12,155,247,12,"Verschlossen?: "..lockedstate,false,Fenster3[1])
	guiLabelSetHorizontalAlign(Label3[9],"center",false)
	guiSetFont(Label3[9],"default-bold-small")
	Knopf3[1] = guiCreateButton(9,175,124,32,"Haus kaufen",false,Fenster3[1])
	Knopf3[2] = guiCreateButton(137,175,124,32,"Haus vermieten",false,Fenster3[1])
	Knopf3[3] = guiCreateButton(9,210,124,32,"Schließen",false,Fenster3[1])
	...
	if(getPlayerName(gMe) == owner) then
		...
		if(isrentedin == true) then
			...
			guiSetText(Knopf3[2], "Haus Verlassen")
		end
	end
	...
	if(owner ~= "no-one") then
		...
		if(owner == getPlayerName(gMe)) then
			...
			guiSetText(Knopf3[1], "Haus Verkaufen")
		end
	end
	-- EVENT HANDLERS --
...
addEventHandler("onClientHouseSystemMenueOpen", gMe, function(owner, locked, money, weap1, weap2, weap3, id, rentable, rent, tenands)
	if(locked == nil) then
		...
		Fenster2[1] = guiCreateWindow(X, Y, Width, Height, "Hausmenü",false)
		Label2[1] = guiCreateLabel(149,23,81,14,"Eaffen",false,Fenster2[1])
		...
		Label2[3] = guiCreateLabel(17,40,106,32,"Haus Bank:\n0$",false,Fenster2[1])
		...
		Knopf2[3] = guiCreateButton(15,175,110,29,"Schließen",false,Fenster2[1])
		Label2[4] = guiCreateLabel(18,23,47,15,"Geld",false,Fenster2[1])
		...
		Radio2[1] = guiCreateRadioButton(303,27,108,21,"Waffen slot 1",false,Fenster2[1])
		guiSetFont(Radio2[1],"default-bold-small")
		Radio2[2] = guiCreateRadioButton(303,47,108,21,"Waffen slot 2",false,Fenster2[1])
		guiSetFont(Radio2[2],"default-bold-small")
		Radio2[3] = guiCreateRadioButton(303,67,108,21,"Waffen slot 3",false,Fenster2[1])
		guiRadioButtonSetSelected(Radio2[3],true)
		guiSetFont(Radio2[3],"default-bold-small")
		Knopf2[4] = guiCreateButton(301,104,107,30,"Lege Waffen",false,Fenster2[1])
		Knopf2[5] = guiCreateButton(301,142,107,30,"Nehme Waffen",false,Fenster2[1])
		Knopf2[6] = guiCreateButton(301,175,107,29,"Verschließen",false,Fenster2[1])
		Label2[12] = guiCreateLabel(412,22,10,189,"|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n|\n",false,Fenster2[1])
		guiLabelSetColor(Label2[12],0, 255, 0)
		guiSetFont(Label2[12],"default-small")
		Label2[13] = guiCreateLabel(424,24,137,15,"Mietbar",false,Fenster2[1])
		...
		Label2[15] = guiCreateLabel(424,41,137,15,"Mietpreis: $0",false,Fenster2[1])
		guiSetFont(Label2[15],"default-bold-small")
		Edit2[2] = guiCreateEdit(441,58,75,24,"",false,Fenster2[1])
		Knopf2[7] = guiCreateButton(424,88,114,27,"Neuer Mietpreis",false,Fenster2[1])
		...
		Checkbox2[1] = guiCreateCheckBox(425,116,111,17,"Bit du Sicher?",false,false,Fenster2[1])
		guiSetFont(Checkbox2[1],"default-bold-small")
		Knopf2[9] = guiCreateButton(423,137,115,30,"Vermietbar",false,Fenster2[1])
		-- SET THE SETTINGS --
		-- TENANDS --
		guiGridListClear(Grid2[1])
		...
		if(rentable == 1) then
			guiSetText(Knopf2[9], "Nicht Vermietbar machen")
		end
		-- RENTALPRICE
		guiSetText(Label2[15], "Mietpreis: $"..rent)
		
		-- LOCKED --
		locked = tonumber(locked)
		if(locked == 1) then
			guiSetText(Knopf2[6], "Haus aufschließen")
		end
		
		-- MONEY --
		guiSetText(Label2[3], "Geld jetzt:\n"..money.."$")
		...
		addEventHandler("onClientGUIClick", Knopf2[8], function()
			if(owner == false) then outputChatBox("Sie sind nicht der Besitzer von diesem Haus!", 255, 0, 0) return end
			local user = guiGridListGetItemText(Grid2[1], guiGridListGetSelectedItem(Grid2[1]), 1)
			if(user == "") or (user == " ") then return end
			if(guiCheckBoxGetSelected(Checkbox2[1]) == false) then outputChatBox("Du musst dir sicher sein!", 255, 0, 0) return end
			triggerServerEvent("onHouseSystemTenandRemove", gMe, id, user)
		end, false)
		
		-- SET RENTALPRICE --
		addEventHandler("onClientGUIClick", Knopf2[7], function()
			if(owner == false) then outputChatBox("Du bist nicht der Besitzer von diesem Haus!", 255, 0, 0) return end
			local value = tonumber(guiGetText(Edit2[2]))
			if(value == nil) or(value < 1) or (value > 20000) then outputChatBox("Falsche eingabe!", 255, 0, 0) return end
		...
		addEventHandler("onClientGUIClick", Knopf2[2], function()
			...
			if(value < 0)  then outputChatBox("falscher geld betrag!", 255, 0, 0) return end
			value = math.floor(value)
		...
		addEventHandler("onClientGUIClick", Knopf2[1], function()
			...
			if(value == "") then return end
			value = tonumber(value)
			if(value < 0) or (value > getPlayerMoney(gMe)-1) then outputChatBox("falscher geld betrag!", 255, 0, 0) return end
			value = math.floor(value)
...
addEventHandler("onClientHouseSystemGUIStart", gMe, function()
	...
	Fenster[1] = guiCreateWindow(X, Y, Width, Height, "Haus system",false)
	...
	Label[3] = guiCreateLabel(161,52,135,30,"X, Y, Z und INT\nvom Haus(Innen):",false,Fenster[1])
	...
	Knopf[1] = guiCreateButton(156,116,112,32,"Setzen --->",false,Fenster[1])
	...
	Knopf[2] = guiCreateButton(13,221,112,32,"Schließen",false,Fenster[1])
	Knopf[3] = guiCreateButton(132,221,107,31,"Haus Erstellen",false,Fenster[1])
	Label[5] = guiCreateLabel(15,22,107,17,"Erstell Eins...:",false,Fenster[1])
	...
	Knopf[4] = guiCreateButton(15,114,112,32,"Meine Position",false,Fenster[1])
	Label[7] = guiCreateLabel(20,50,135,30,"X, Y, Z Position\nvom  Haus(Außen):",false,Fenster[1])
	guiSetFont(Label[7],"default-bold-small")
	Label[8] = guiCreateLabel(18,157,46,19,"Preis:",false,Fenster[1])
	...
	guiGridListAddColumn(Grid[1],"Name",1)
	...
	addEventHandler("onClientGUIClick", Grid[1], function()
		...
		if(text == "") or (text == " ") then
			guiStaticImageLoadImage(Bild[1], "Images/house/choose.jpg")
		else
			if(fileExists("Images/house/"..text..".jpg")) then
				guiStaticImageLoadImage(Bild[1], "Images/house/"..text..".jpg")
			else
				guiStaticImageLoadImage(Bild[1], "Images/house/choose.jpg")
			end
		end
	...
	addEventHandler("onClientGUIClick", Knopf[1], function()
		...
		if(id == nil) then outputChatBox("Wähle ein haus Interrior ", 255, 0, 0) return end
				...
				if(isLineOfSightClear(x, y, z, x2, y2, z2, true, true, false, true)) then
					...
					if(sx) and (sy) then
						...
						if(distance < 20) then
							...
							local price = getElementData(house, "Preis")
							local locked = getElementData(house, "Verschlossen")
							...
							if(owner) and (price) and (locked) and (houseid) then
								if(owner ~= "no-one") then
									...
									if(rentable == 1) then
										dxDrawText("Haus: "..houseid.." ("..zone..")\nBesitzer: "..owner.."\nPreis: $"..price.."\nDas haus ist Vermietbar Preis: $"..rentalprice.."\nThis House is "..lockedstate..".", sx+2, sy+2, sx, sy, tocolor(0, 0, 0, 200), fontbig, "default-bold", "center")
										dxDrawText("Haus: "..houseid.." ("..zone..")\nBesitzer: "..owner.."\nPrice: $"..price.."\nDas haus ist Vermietbar Preis: $"..rentalprice.."\nThis House is "..lockedstate..".", sx+2, sy+2, sx, sy, tocolor(255, 255, 255, 200), fontbig, "default-bold", "center")
									else
										dxDrawText("Haus: "..houseid.." ("..zone..")\nBesitzer: "..owner.."\nPreis: $"..price.."\nNicht Vermietbar!\nDas haus ist: "..lockedstate..".", sx+2, sy+2, sx, sy, tocolor(0, 0, 0, 200), fontbig, "default-bold", "center")
										dxDrawText("Haus: "..houseid.." ("..zone..")\nOwner: "..owner.."\nPrice: $"..price.."\nNicht Vermietbar!\nDas haus ist: "..lockedstate..".", sx, sy, sx, sy, tocolor(255, 255, 255, 200), fontbig, "default-bold", "center")
									end
								else
									dxDrawText("Haus: "..houseid.." ("..zone..")\nBesitzer: "..owner.."\nPreis: $"..price.."\nZum kaufen benutze: /kaufh \nDas haus ist: "..lockedstate..".", sx+2, sy+2, sx, sy, tocolor(0, 0, 0, 200), fontbig, "default-bold", "center")
									dxDrawText("Haus: "..houseid.." ("..zone..")\nBesitzer: "..owner.."\nPreis: $"..price.."\nZum kaufen benutze: /kaufh \nDas haus ist: "..lockedstate..".", sx, sy, sx, sy, tocolor(255, 255, 255, 200), fontbig, "default-bold", "center")
								end
							end
						end
