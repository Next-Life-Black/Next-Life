...
addEvent("onPlayerGetSnow",true)
addEventHandler("onPlayerGetSnow",getRootElement(), startSnow)
...
function enableGoundSnow()
	...
	snowShader = dxCreateShader ( "Feiertage/Weinachten/snow_ground.fx", 0, maxEffectDistance )
	treeShader = dxCreateShader( "Feiertage/Weinachten/snow_trees.fx" )
	naughtyTreeShader = dxCreateShader( "Feiertage/Weinachten/snow_naughty_trees.fx" )
	sNoiseTexture = dxCreateTexture( "Feiertage/Weinachten/smallnoise3d.dds" )
...
addEvent("onPlayerStartShader",true)
addEventHandler("onPlayerStartShader",getRootElement(), enableGoundSnow)
